...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="">
				<div class="input-group">
			      ...
			      <input type="date" placeholder="开始时间"  name="createtime" class="" id="txt_search_createtime1" >--
				  <input type="date" placeholder="结束时间"  name="createtime" class="" id="txt_search_createtime2" >
				</div>
			  </div>
	...
	<!-- 添加附表对话框 -->
	<div class="modal fade" id="modal_g_edit" role="dialog" aria-labelledby="modal_g_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_g" method="post" action="reserveg.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>商品类型名称：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_g_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" enctype="multipart/form-data" action="import.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>请选择文件夹：</td>
								<td><input type="file" id="goodFile" name="goodFile"
	...
	$(function () {
	    ...
	    $("#submit_form_g_btn").click(function(){
	    	$("#form_g").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addg").click(function(){
	    		$("#form_g").resetForm();
	    		$('#modal_g_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_g_edit').modal('show');
	        });
	    		    ...
	    		    success:function(res){
	    		    	if(res.success){
	    		    	    ...
	    		    	    res.data.forEach(function(b){
	    		    	    	xdata.push(b.tname);
	    		    	    	ydata.push({value: b.num, name: b.tname});
	    		    	    });
	    		    		var	option = {
	    		    			    title: {
	    		    			        text: '某站点用户访问来源',
	...
	function initEditUser(getSelection){
		...
		$('#status option[value="'+getSelection.status+'"]').prop("checked",true);
